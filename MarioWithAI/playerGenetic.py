...
class PlayerGenetic(PhysicsEntity):  # Inherit from PhysicsEntity
    ...
    def update(self, movement=(0, 0)):
        ...
        if self.game.currentLevel.current_time < 250 and self.game.player.pos[0] < 300:
            self.game.player.die()

        if self.game.currentLevel.current_time < 200 and self.game.player.pos[0] < 700:
            self.game.player.die()

        if self.game.currentLevel.current_time < 150 and self.game.player.pos[0] < 1000:
            self.game.player.die()
